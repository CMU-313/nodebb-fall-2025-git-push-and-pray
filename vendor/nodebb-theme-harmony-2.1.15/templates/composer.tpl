<div component="composer" class="composer {{{ if resizable }}} resizable{{{ end }}}{{{ if !isTopicOrMain }}} reply{{{ end }}}">
	<div class="composer-container d-flex flex-column gap-1 h-100">
		...
		<div class="p-2 d-flex flex-column gap-1 h-100">
			...
			{{{ if !isTopicOrMain }}}
			<div class="anonymous-option-container d-flex align-items-center gap-2 py-2">
				<div class="form-check form-switch">
					<input class="form-check-input" type="checkbox" id="anonymousSwitch" component="composer/anonymous">
					<label class="form-check-label" for="anonymousSwitch">
						<i class="fa fa-user-secret me-1"></i>Post Anonymously
					</label>
				</div>
			</div>
			{{{ end }}}
